...
predictors = ['price', 'sqft_living', 'sqft_lot', 'bins', 'POC_pct', 'median_income', 'TREE_PCT', 
               'osdist_mean', 'os_per_person_pctle', 'longitude', 'latitude',                            
               'Vacant(Single-family)', 'Apartment', 
               'Condominium(Residential)','4-Plex', 'Vacant(Multi-family)',                                              
               'Office Building', 'Apartment(Mixed Use)']
```
...
m_a_err_ex01 = mean_absolute_error(y_test_pred_02, y_test_ex01)
